...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: new WeatherInfo(title: "北京天气",),
    );
  }
}
...
class WeatherInfo extends StatefulWidget {
  ...
  WeatherInfo({Key key, this.title}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return new WeatherInfoState();
  }
}
...
class WeatherInfoState extends State<WeatherInfo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          Text(weatherData == null ? "":"【基本信息】", style: new TextStyle(color: Colors.red)),
          weatherData == null ? Text("") : buildBaseInfo(weatherData),
          Text(weatherData == null ? "":"【当前天气】", style: new TextStyle(color: Colors.red)),
          weatherData == null ? Text("") : buildCurrent(weatherData),
          Text(weatherData == null ? "":"【昨日天气】", style: new TextStyle(color: Colors.red)),
          weatherData == null ? Text("") : buildYesterday(weatherData),
          Text(weatherData == null ? "":"【未来预报】", style: new TextStyle(color: Colors.red)),
